...
from model_rgb_flow import Model
from torch.utils.data import DataLoader
from data_set_reader_flow import DataSetReader
from torch.utils.tensorboard import SummaryWriter
os.environ["CUDA_VISIBLE_DEVICES"] = "0"


def init_parse():
    parser = argparse.ArgumentParser(description="HCMFN")
    ...
    parser.add_argument('--output', type=str, default='Outputs_flow', help='')
